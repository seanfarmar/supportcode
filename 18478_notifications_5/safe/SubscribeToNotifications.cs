    ...
    IDisposable
{
    ...
    static string ConversationIdKey = "NServiceBus.ConversationId";
    ...
    {
        log.Fatal("Message sent to error queue and ConversationIdKey: " + failedMessage.Headers[ConversationIdKey]);
    }
    ...
    {
        log.Fatal($"Message sent to FLR. RetryAttempt:{firstLevelRetry.RetryAttempt} and ConversationIdKey: {firstLevelRetry.Headers[ConversationIdKey]}");
    }
