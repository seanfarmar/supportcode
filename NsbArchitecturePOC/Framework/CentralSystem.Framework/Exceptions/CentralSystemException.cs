...
{
    /// <summary>
    /// Central system basic exception class
    /// </summary>
    [Serializable]
    public class CentralSystemException : Exception
    {
        ...
        /// </summary>
        public const int DEFAULT_ERROR_CODE = 100000;
        ...
        public CentralSystemException(int errorCode, string message)
            : base(message)
        {
        ...
        public CentralSystemException(int errorCode, string message, Exception innerException)
        ...
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        public CentralSystemException(string message)
            : base(message)
        {
            m_ErrorCode = DEFAULT_ERROR_CODE;
        }
        ...
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception.</param>
        public CentralSystemException(string message, Exception innerException)
            : base(message, innerException)
        {
            m_ErrorCode = DEFAULT_ERROR_CODE;
        }
        ...
        protected CentralSystemException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        /// <summary>
        /// Get exception error code or default
        /// </summary>
        ...
        public static int GetErrorCode(Exception exception)
        {
            ...
            CentralSystemException csException = exception as CentralSystemException;
            if (csException != null)
            {
                errorCode = csException.ErrorCode;
            }
            return errorCode;
        }
