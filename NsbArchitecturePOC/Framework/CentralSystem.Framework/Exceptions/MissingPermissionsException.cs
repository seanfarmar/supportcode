...
namespace CentralSystem.Framework.Exceptions
{
    ...
    public class MissingPermissionsException : Exception
    {
        ...
        public MissingPermissionsException(int errorCode, string message)
            : base(message)
        {
        ...
        public MissingPermissionsException(int errorCode, string message, Exception innerException)
        ...
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception.</param>
        public MissingPermissionsException(string message, Exception innerException)
            : base(message, innerException)
        {
            m_ErrorCode = DEFAULT_ERROR_CODE;
        }
        ...
        protected MissingPermissionsException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
