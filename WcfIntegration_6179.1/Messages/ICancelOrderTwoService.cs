...
namespace Messages
{
    ...
    public interface ICancelOrderTwoService
    {
        [OperationContract(Action = "http://nservicebus.com/IWcfServiceOf_CancelOrderTwo_ErrorCodes/Process", ReplyAction = "http://nservicebus.com/IWcfServiceOf_CancelOrderTwo_ErrorCodes/ProcessResponse")]
        ErrorCodes Process(CancelOrderTwo request);
    }
}